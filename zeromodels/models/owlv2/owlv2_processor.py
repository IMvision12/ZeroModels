...
class Owlv2Processor(BaseProcessor):
    ...
    (``Owlv2Processor.from_weights("zeromodels/owlv2-base-patch16")``), or pass
    ...
    detected by the class predictor. Image preprocessing follows the OWLv2 spec:
    rescale -> pad-to-square -> resize -> normalize.

    Args:
        hf_id: Hub repo carrying the model's ``tokenizer.json`` (OWLv2 shares
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hf_id = hf_id
        self.tokenizer = tokenizer or Owlv2Tokenizer(hf_id=hf_id)
