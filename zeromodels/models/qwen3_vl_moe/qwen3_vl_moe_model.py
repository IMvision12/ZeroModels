...
from zeromodels.models.qwen2_vl.qwen2_vl_model import Qwen2VLModel
from zeromodels.models.qwen3_moe.qwen3_moe_layers import Qwen3MoeSparseBlock
...
class Qwen3VLMoeConditionalGenerate(Qwen3VLMoeModel, BaseGeneration):
    ...
    Same fast multimodal generation as :class:`~zeromodels.models.qwen3_vl.Qwen3VLConditionalGenerate`:
...
class Qwen3VLMoeTextGenerate(Qwen3VLMoeConditionalGenerate):
    ...
    language-model weights, and a zeromodels checkpoint declaring
    ...
    CHECKPOINT_SOURCE = CheckpointSource(
        ...
        module="zeromodels.models.qwen3_vl_moe.qwen3_vl_moe_model",
        match="path",
    )
