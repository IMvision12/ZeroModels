...
def glm4_rope_tables(position_ids, rotary_dim, rope_theta, compute_dtype):
...
def glm4_backbone_features(
    ...
    *,
    ...
    cos, sin = glm4_rope_tables(position_ids, rotary_dim, rope_theta, compute_dtype)
...
class Glm4Model(BaseModel):
    ...
    attention, partial *interleaved* rotary, biased q/k/v, fused-SwiGLU MLP. A
    functional model: the forward is a static graph over ``input_ids`` /
    ``attention_mask``. Returns raw features; use :class:`Glm4TextGenerate` for
    logits / text.
    ...
    # Glm4TextGenerate flips this on to also emit LM-head logits from the graph.
    output_logits = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        final_norm = Glm4RMSNorm(eps=norm_eps, name="final_norm")
    ...
    def rope_tables(self, position_ids):
        ...
        # wires glm4_rope_tables directly.
        return glm4_rope_tables(
