...
class Qwen2VLConditionalGenerate(Qwen2VLModel, BaseGeneration):
    ...
    generation comes from :class:`~zeromodels.base.BaseGeneration`'s multimodal
...
class Qwen2VLTextGenerate(Qwen2VLConditionalGenerate):
    ...
    never reads the vision keys), and a zeromodels checkpoint declaring
    ...
    CHECKPOINT_SOURCE = CheckpointSource(
        ...
        module="zeromodels.models.qwen2_vl.qwen2_vl_model",
        match="path",
    )
