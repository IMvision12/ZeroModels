...
class WhisperModel(BaseModel):
    ...
    >>> WhisperModel.from_weights("whisper_tiny")             # zeromodels release
    ...
    .. note::
        Unlike vision models in zeromodels, Whisper has a **fixed input
    ...
    def transfer_from_hf(cls, keras_model, hf_state_dict):
        from zeromodels.models.whisper.convert_whisper_hf_to_keras import (
...
class WhisperConditionalGenerate(WhisperModel, BaseSeq2SeqGeneration):
    ...
    :class:`~zeromodels.models.whisper.WhisperProcessor` for feature
    ...
    + ``.generate()``) and the zeromodels detection-style pattern
