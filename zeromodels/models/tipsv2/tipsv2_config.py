...
class Tipsv2VisionConfig(BaseConfig):
    ...
    ```python
    >>> from zeromodels.models.tipsv2 import Tipsv2VisionConfig
...
class Tipsv2TextConfig(BaseConfig):
    ...
    ```python
    >>> from zeromodels.models.tipsv2 import Tipsv2TextConfig
...
class Tipsv2Config(BaseConfig):
    ...
    ```python
    >>> from zeromodels.models.tipsv2 import Tipsv2Config, Tipsv2Model
