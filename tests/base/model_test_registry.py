...
MODEL_TEST_CONFIGS = {
    ...
    "BeitImageClassify": {
        "module": "zeromodels.models.beit",
        "model_cls": "BeitImageClassify",
        "model_type": "classification",
        "init_kwargs": {
            "hidden_size": 96,
            "num_hidden_layers": 2,
    ...
    "BeitSemanticSegment": {
        ...
        "input_shape": (2, 64, 64, 3),
        "expected_output_shape": (2, 16, 16, 150),
    },
    ...
    "BartConditionalGenerate": {
        "module": "zeromodels.models.bart",
        "model_cls": "BartConditionalGenerate",
        "model_type": "llm",
        "init_kwargs": {
            "vocab_size": 128,
            "hidden_dim": 32,
    ...
    "BartSequenceClassify": {
        "module": "zeromodels.models.bart",
        "model_cls": "BartSequenceClassify",
        "model_type": "llm",
        "init_kwargs": {
            "vocab_size": 128,
            "hidden_dim": 32,
