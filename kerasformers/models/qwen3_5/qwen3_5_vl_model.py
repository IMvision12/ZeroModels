...
def qwen3_5_multimodal_features(
    input_ids,
    attention_mask,
    position_ids,
    pixel_values,
    ...
    *,
    ...
    # (no-op merge when a stream's token is absent); interleaved partial-rotary
...
class Qwen3_5VLModel(Qwen2VLModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        hidden = qwen3_5_multimodal_features(
            inputs["input_ids"],
