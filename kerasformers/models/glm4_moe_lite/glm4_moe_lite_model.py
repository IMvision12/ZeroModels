...
def glm4_moe_lite_build_rope(
    rotary_dim, rope_theta, rope_scaling, max_position_embeddings
):
...
def glm4_moe_lite_rope_tables(position_ids, inv_freq, attention_scaling, compute_dtype):
...
def glm4_moe_lite_backbone_features(
    input_ids,
    attention_mask,
    *,
    token_embedding,
    ...
    cos, sin = glm4_moe_lite_rope_tables(
...
class Glm4MoeLiteModel(BaseModel):
    ...
    :class:`Glm4MoeLiteTextGenerate` for logits / text.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        inv_freq, attention_scaling = glm4_moe_lite_build_rope(
        ...
        final_norm = Glm4MoeLiteRMSNorm(eps=norm_eps, name="final_norm")
        ...
        hidden = glm4_moe_lite_backbone_features(
            inputs["input_ids"],
    ...
    def rope_tables(self, position_ids):
        return glm4_moe_lite_rope_tables(
